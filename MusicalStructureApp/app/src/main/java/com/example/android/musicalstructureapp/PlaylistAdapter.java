...
public class PlaylistAdapter extends ArrayAdapter<Playlist>{
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent)
    {
        ...
        // Find the TextView in the list_item.xml layout with the playlist name text view
        ...
        // Find the TextView in the list_item.xml layout with the playlist play mode text view
